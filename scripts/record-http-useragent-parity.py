...
def mapping(qualified_name: str) -> tuple[str, str, str]:
    ...
    if class_name == "UserAgentInfo":
        return (
            "hutool_http::useragent::UserAgentInfo",
            "crates/hutool-http/src/useragent.rs::information_rules_compare_hash_and_display_by_name",
    ...
    if class_name == "Browser":
        return (
            "hutool_http::useragent::Browser",
            "crates/hutool-http/src/useragent.rs::custom_rules_and_mutators_are_supported",
    ...
    if class_name == "Engine":
        return (
            "hutool_http::useragent::Engine",
            "crates/hutool-http/src/useragent.rs::parses_desktop_chrome_with_versions",
            "Rendering-engine detection and version extraction use owned Rust values with name-based identity.",
        )
    if class_name == "OS":
        return (
            "hutool_http::useragent::OperatingSystem",
            "crates/hutool-http/src/useragent.rs::parses_mobile_wechat_and_ios_helpers",
    ...
    if class_name == "Platform":
        return (
            "hutool_http::useragent::Platform",
            "crates/hutool-http/src/useragent.rs::platform_family_helpers_cover_all_families",
    ...
    if class_name == "UserAgent":
        return (
            "hutool_http::useragent::UserAgent",
            "crates/hutool-http/src/useragent.rs::custom_rules_and_mutators_are_supported",
            "The owned aggregate exposes every Hutool browser, engine, OS, platform, version and mobile getter/setter capability.",
        )
    return (
        "hutool_http::useragent::{UserAgentParser,UserAgentUtil}",
        "crates/hutool-http/src/useragent.rs::blank_unknown_and_woothee_fallbacks_are_safe",
