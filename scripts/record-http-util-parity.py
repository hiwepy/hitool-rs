...
DECISIONS_BY_MEMBER = {
    "HttpUtil": (
        "idiomatic",
        "hutool_http::HttpUtil",
        "crates/hutool-http/tests/http_util_offline_parity.rs::is_http_test",
        "Stateless Hutool HttpUtil facade over offline param helpers and secure HttpRequest networking.",
    ),
    "isHttps": (
        "idiomatic",
        "hutool_http::HttpUtil::is_https",
        "crates/hutool-http/tests/http_util_offline_parity.rs::is_https_test",
        "Case-insensitive https: scheme prefix check.",
    ),
    "isHttp": (
        "idiomatic",
        "hutool_http::HttpUtil::is_http",
        "crates/hutool-http/tests/http_util_offline_parity.rs::is_http_test",
        "Case-insensitive http: scheme prefix check.",
    ),
    "createRequest": (
        "idiomatic",
        "hutool_http::HttpUtil::create_request",
    ...
    "createGet": (
        "idiomatic",
        "hutool_http::HttpUtil::create_get",
    ...
    "createPost": (
        "idiomatic",
        "hutool_http::HttpUtil::create_post",
    ...
    "get": (
        "idiomatic",
        "hutool_http::HttpUtil::get",
        "crates/hutool-http/tests/http_util_request_facade_parity.rs::http_util_get_with_form_appends_query",
        "Async GET facades (timeout/form overloads) over HttpRequest with max-body and URL policy.",
    ),
    "post": (
        "idiomatic",
        "hutool_http::HttpUtil::post_form",
    ...
    "downloadString": (
        "idiomatic",
        "hutool_http::HttpUtil::download_string",
        "crates/hutool-http/tests/http_util_request_facade_parity.rs::http_util_download_bytes",
        "Downloads bytes then decodes via encoding_rs; StreamProgress overload is planned.",
    ),
    "downloadBytes": (
        "idiomatic",
        "hutool_http::HttpUtil::download_bytes",
        "crates/hutool-http/tests/http_util_request_facade_parity.rs::http_util_download_bytes",
        "Bounded byte download via HttpRequest::execute_bytes.",
    ),
    "downloadFile": (
        "idiomatic",
        "hutool_http::HttpUtil::download_file",
        "crates/hutool-http/tests/http_util_request_facade_parity.rs::http_util_download_bytes",
        "Buffers then writes with std::fs; timeout overload via download_file_timeout; StreamProgress variants remain planned.",
    ),
    "downloadFileFromUrl": (
        "idiomatic",
        "hutool_http::HttpUtil::download_file_from_url",
        "crates/hutool-http/tests/http_util_request_facade_parity.rs::http_util_download_writer_and_file_from_url",
        "Buffers via HttpRequest then HttpResponse::write_body_for_file; StreamProgress overloads remain planned.",
    ),
    "download": (
        "idiomatic",
        "hutool_http::HttpUtil::download",
        "crates/hutool-http/tests/http_util_request_facade_parity.rs::http_util_download_writer_and_file_from_url",
        "Writes downloaded bytes to a Write sink; StreamProgress overload remains planned.",
    ),
    "toParams": (
        "idiomatic",
        "hutool_http::HttpUtil::to_params",
        "crates/hutool-http/tests/http_util_offline_parity.rs::http_util_test_to_params_test",
        "Query encoding with optional form-urlencoded mode; Charset args use UTF-8.",
    ),
    "encodeParams": (
        "idiomatic",
        "hutool_http::HttpUtil::encode_params",
        "crates/hutool-http/tests/http_util_offline_parity.rs::http_util_test_encode_param_test",
        "Normalizes URL query fragments; Charset folded to UTF-8 percent-encoding.",
    ),
    "normalizeParams": (
        "idiomatic",
        "hutool_http::HttpUtil::normalize_params",
        "crates/hutool-http/tests/http_util_offline_parity.rs::http_util_test_normalize_params_test",
        "Parameter pair normalization with optional encoding.",
    ),
    "decodeParamMap": (
        "idiomatic",
        "hutool_http::HttpUtil::decode_param_map",
        "crates/hutool-http/tests/http_util_offline_parity.rs::http_util_test_decode_param_map_test",
        "Single-value query map decode from URL or raw query.",
    ),
    "decodeParams": (
        "idiomatic",
        "hutool_http::HttpUtil::decode_params",
        "crates/hutool-http/tests/http_util_offline_parity.rs::http_util_test_decode_params_test",
        "Multi-value query decode including form-urlencoded mode overloads.",
    ),
    "urlWithForm": (
        "idiomatic",
        "hutool_http::HttpUtil::url_with_form",
        "crates/hutool-http/tests/http_util_offline_parity.rs::http_util_test_url_with_form_test",
        "Appends map or raw query to URL with optional encoding.",
    ),
    "urlWithFormUrlEncoded": (
        "idiomatic",
        "hutool_http::HttpUtil::url_with_form_url_encoded",
        "crates/hutool-http/tests/http_util_offline_parity.rs::issue3536_test_url_with_form_url_encoded_test",
        "Issue #3536 form-urlencoded append semantics.",
    ),
    "getCharset": (
        "idiomatic",
        "hutool_http::HttpUtil::get_charset",
        "crates/hutool-http/tests/http_util_offline_parity.rs::http_util_get_charset_string_test",
        "Content-Type charset extraction; HttpURLConnection overload is Java-specific planned.",
    ),
    "getString": (
        "idiomatic",
        "hutool_http::HttpUtil::get_string",
        "crates/hutool-http/tests/http_util_offline_parity.rs::http_util_get_string_bytes_test",
        "encoding_rs decode with optional HTML meta charset re-detect; InputStream overload uses bytes.",
    ),
    "getMimeType": (
        "idiomatic",
        "hutool_http::HttpUtil::get_mime_type",
        "crates/hutool-http/tests/http_util_offline_parity.rs::http_util_get_mime_type_default_test",
        "Extension-based MIME guess with default-value overload.",
    ),
    "getContentTypeByRequestBody": (
        "idiomatic",
        "hutool_http::HttpUtil::get_content_type_by_request_body",
        "crates/hutool-http/tests/http_util_offline_parity.rs::http_util_get_content_type_by_request_body_test",
        "Delegates to ContentType::detect for JSON/XML bodies.",
    ),
    "buildBasicAuth": (
        "idiomatic",
        "hutool_http::HttpUtil::build_basic_auth",
        "crates/hutool-http/tests/http_util_offline_parity.rs::http_util_build_basic_auth_test",
        "UTF-8 Basic Authorization header via hutool_core base64.",
    ),
    "createServer": (
        "planned",
        "",
        "",
        "SimpleServer is out of scope for the client-focused hutool-http crate.",
    ),
    "closeCookie": (
        "idiomatic",
        "hutool_http::GlobalCookieManager::close_cookie",
    ...
    for row in inventory:
        ...
        if member == "downloadString" and "StreamProgress" in row["api_id"]:
            indexed[row["api_id"]] = {
                "api_id": row["api_id"],
                "status": "idiomatic",
                "hutool_symbol": "hutool_http::HttpUtil::download_string_with_progress",
                "test_evidence": "crates/hutool-http/src/http_util.rs::download_string_with_progress",
        ...
        if member == "downloadFile" and "StreamProgress" in row["api_id"]:
            indexed[row["api_id"]] = {
                "api_id": row["api_id"],
                "status": "idiomatic",
                "hutool_symbol": "hutool_http::HttpUtil::download_file_with_progress",
                "test_evidence": "crates/hutool-http/src/http_util.rs::download_file_with_progress",
        ...
        if member == "downloadFileFromUrl" and "StreamProgress" in row["api_id"]:
            indexed[row["api_id"]] = {
                "api_id": row["api_id"],
                "status": "idiomatic",
                "hutool_symbol": "hutool_http::HttpUtil::download_file_from_url_with_progress",
                "test_evidence": "crates/hutool-http/src/http_util.rs::download_file_from_url_with_progress",
        ...
        if member == "download" and "StreamProgress" in row["api_id"]:
            indexed[row["api_id"]] = {
                "api_id": row["api_id"],
                "status": "idiomatic",
                "hutool_symbol": "hutool_http::HttpUtil::download_with_progress",
                "test_evidence": "crates/hutool-http/src/http_util.rs::download_with_progress",
        ...
        if member == "closeCookie":
            indexed[row["api_id"]] = {
                "api_id": row["api_id"],
                "status": "idiomatic",
                "hutool_symbol": "hutool_http::GlobalCookieManager::close_cookie",
                "test_evidence": "crates/hutool-http/src/cookie/mod.rs::global_cookie_manager_store_and_close",
