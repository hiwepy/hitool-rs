...
def mapping(qualified_name: str) -> tuple[str, str, str]:
    ...
    if class_name in {"JSONArray", "JSONArraySerializer"}:
        return (
            "hutool_json::JSONArray",
            "crates/hutool-json/src/compat.rs::array_mutations_paths_and_formatting_are_complete",
    ...
    if class_name in {"JSONObject", "JSONObjectIter", "JSONObjectSerializer", "JSONGetter"}:
        return (
            "hutool_json::JSONObject",
            "crates/hutool-json/src/compat.rs::object_mutations_cover_case_null_duplicates_arrays_and_numbers",
    ...
    if class_name in {"JSONConfig", "JSONNull", "JSON"}:
        return (
            "hutool_json::{JSONConfig,JSONNull,JsonContainer}",
            "crates/hutool-json/src/compat.rs::config_exposes_every_hutool_option",
    ...
    if class_name in {"JSONTokener", "JSONParser", "ParseConfig"}:
        return (
            "hutool_json::{JSONTokener,JSONParser,ParseConfig}",
            "crates/hutool-json/src/parser.rs::readers_parsers_and_string_errors_are_explicit",
    ...
    if class_name in {"XML", "XMLTokener", "JSONXMLParser", "JSONXMLSerializer"}:
        return (
            "hutool_json::{XML,XMLTokener,JSONXMLParser,JSONXMLSerializer}",
            "crates/hutool-json/src/xml.rs::xml_parses_attributes_repeated_tags_scalars_cdata_and_empty_nodes",
    ...
    if class_name in {
        ...
        return (
            "hutool_json::{SerializeRegistry,GlobalSerializeMapping,JSONSerializer,JSONDeserializer}",
            "crates/hutool-json/src/serialize.rs::owned_registry_maps_both_directions_and_reports_missing_types",
    ...
    if class_name == "JSONWriter":
        return (
            "hutool_json::JSONWriter",
            "crates/hutool-json/src/facade.rs::writer_enforces_state_nulls_and_long_strings",
    ...
    if class_name in {
        ...
        return (
            "hutool_json::{JSONUtil,JSONStrFormatter,JSONSupport,JSONConverter,ObjectMapper}",
            "crates/hutool-json/src/facade.rs::util_support_converter_and_mapper_delegate_to_serde",
    ...
    return (
        "hutool_json::{JsonError,parse,to_string,from_str}",
        "crates/hutool-json/src/lib.rs::formatting_is_reversible",
