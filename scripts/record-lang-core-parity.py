...
FAMILIES: list[tuple[str, str, str, str, str]] = [
    ...
    (
        ...
        "idiomatic",
        "hitool_core::Assert",
        "crates/hitool-core/src/lang/assert_.rs::assert_core_paths_cover_true_null_empty_between_and_equals",
    ...
    (
        ...
        "idiomatic",
        "hitool_core::Validator",
        "crates/hitool-core/tests/validator_parity.rs",
    ...
    (
        ...
        "idiomatic",
        "hitool_core::RegexPool",
        "crates/hitool-core/src/lang/regex_pool.rs::regex_pool_core_constants_compile_and_match",
        "Static &str constants mirror Hutool RegexPool; compilation/caching lives in PatternPool.",
    ),
    (
        "cn.hutool.core.lang::PatternPool",
        "idiomatic",
        "hitool_core::PatternPool",
        "crates/hitool-core/src/lang/pattern_pool.rs::pattern_pool_get_remove_clear_and_flag_key",
    ...
    (
        ...
        "idiomatic",
        "hitool_core::DictUtil",
        "crates/hitool-core/src/dict.rs::dict_create_set_get_filter_parse_and_to_bean",
    ...
    (
        ...
        "idiomatic",
        "hitool_core::Opt",
        "crates/hitool-core/tests/opt_parity.rs",
    ...
    (
        ...
        "idiomatic",
        "hitool_core::Pair",
        "crates/hitool-core/src/lang/pair.rs::pair_of_getters_equals_and_display",
    ...
    (
        ...
        "idiomatic",
        "hitool_core::Snowflake",
        "crates/hitool-core/src/lang/snowflake.rs::snowflake_next_id_and_field_extract",
    ...
    (
        ...
        "idiomatic",
        "hitool_core::Pid",
        "crates/hitool-core/src/lang/pid.rs::pid_get_is_positive_and_stable",
    ...
    (
        ...
        "idiomatic",
        "hitool_core::Console",
        "crates/hitool-core/src/lang/console.rs::console_format_and_progress",
    ...
    (
        ...
        "idiomatic",
        "hitool_core::ConsoleTable",
        "crates/hitool-core/src/lang/console_table.rs::console_table_render",
    ...
    (
        ...
        "idiomatic",
        "hitool_core::UUID",
        "crates/hitool-core/src/lang/uuid_fast.rs::uuid_bits_from_string_and_compare",
    ...
    (
        ...
        "idiomatic",
        "hitool_core::Tuple",
        "crates/hitool-core/src/lang/tuple.rs::tuple_get_size_contains_sub_and_display",
        "serde_json::Value members preserve Eq/Display; Stream/Spliterator map to iterators/to_list.",
    ),
    (
        "cn.hutool.core.lang::WeightRandom",
        "idiomatic",
        "hitool_core::WeightRandom",
        "crates/hitool-core/src/lang/weight_random.rs::weight_random_add_next_clear_and_weight_obj",
    ...
    (
        ...
        "idiomatic",
        "hitool_core::WeightListRandom",
        "crates/hitool-core/src/lang/weight_list_random.rs::weight_list_random_samples",
        "Thin WeightRandom facade for list-style weighted picks.",
    ),
    (
        "cn.hutool.core.lang::SimpleCache",
        "idiomatic",
        "hitool_core::SimpleCache",
        "crates/hitool-core/src/lang/simple_cache.rs::simple_cache_put_get_or_put_and_clear",
    ...
    (
        ...
        "idiomatic",
        "hitool_core::Singleton",
        "crates/hitool-core/src/lang/singleton.rs::singleton_get_put_exists_remove",
    ...
    (
        ...
        "idiomatic",
        "hitool_core::Range",
        "crates/hitool-core/src/lang/range.rs::int_range_to_list",
        "Stepper closure Range with hasNext/next/to_list; lock/disableLock no-ops under Rust ownership.",
    ),
    (
        "cn.hutool.core.lang::ObjectId",
        "idiomatic",
        "hitool_core::ObjectId",
        "crates/hitool-core/src/lang/object_id.rs::object_id_valid_and_next",
    ...
    (
        ...
        "idiomatic",
        "hitool_core::Version",
        "crates/hitool-core/src/lang/version.rs::version_of_compare_and_equals",
        "ModuleDescriptor-style Version parse/compare for sequence/pre/build tokens.",
    ),
    (
        "cn.hutool.core.lang::ConsistentHash",
        "idiomatic",
        "hitool_core::ConsistentHash",
        "crates/hitool-core/src/lang/consistent_hash.rs::consistent_hash_add_get_remove",
        "BTreeMap ring with FNV32 default hash and replica virtual nodes.",
    ),
    (
        "cn.hutool.core.lang::DefaultSegment",
        "idiomatic",
        "hitool_core::DefaultSegment",
        "crates/hitool-core/src/lang/default_segment.rs::default_segment_indexes_and_length",
    ...
    (
        ...
        "idiomatic",
        "hitool_core::Editor",
        "crates/hitool-core/src/lang/editor.rs::editor_maps_and_filters",
    ...
    (
        ...
        "idiomatic",
        "hitool_core::Filter",
        "crates/hitool-core/src/lang/filter.rs::filter_accepts_matching",
    ...
    (
        ...
        "idiomatic",
        "hitool_core::Matcher",
        "crates/hitool-core/src/lang/matcher.rs::matcher_filters_matching",
        "Functional Matcher trait (match -> match_item) with match_all helper.",
    ),
    (
        "cn.hutool.core.lang::Replacer",
        "idiomatic",
        "hitool_core::Replacer",
        "crates/hitool-core/src/lang/replacer.rs::replacer_maps_values",
    ...
    (
        ...
        "idiomatic",
        "hitool_core::KetamaHash",
        "crates/hitool-core/src/lang/hash/ketama_hash.rs::ketama_hash32_matches_hash64_low_bits",
    ...
    (
        ...
        "idiomatic",
        "hitool_core::NanoId",
        "crates/hitool-core/src/lang/id/nano_id.rs::nano_id_default_and_sized",
        "URL-safe NanoId with default/size/alphabet+JavaRandom overloads.",
    ),
    (
        "cn.hutool.core.lang.id::IdConstants",
        "idiomatic",
        "hitool_core::IdConstants",
        "crates/hitool-core/src/lang/id/id_constants.rs::id_constants_default_snowflake",
