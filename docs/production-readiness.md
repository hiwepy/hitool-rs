...
| 100% test coverage | in progress | current all-feature baseline: lines 98.41% (23,605/23,987), regions 98.38% (38,705/39,342), functions 97.83% (3,202/3,273); the facade registry, JWT, cache, system, cron, setting, AI, log, JSON, and HTTP crates are each exactly 100%; `hitool-http` contributes 2,248 regions, 204 functions, and 1,393 lines, while CI requires 100% workspace-wide |
