...
| Complete Hutool functional parity | in progress | pinned v5.8.46 inventory contains 13,871 public production API records; all 175 `cn.hutool.core.codec` records currently have implementation and executable test evidence |
...
| 100% test coverage | in progress | current all-feature baseline: lines 82.64%, regions 83.56%, functions 79.97%; CI requires 100% for all three |
