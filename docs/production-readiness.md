...
| 100% test coverage | in progress | current all-feature baseline: lines 98.42% (23,862/24,244), regions 98.40% (39,189/39,826), functions 97.86% (3,243/3,314); the facade registry, JWT, cache, system, cron, setting, AI, log, JSON, and HTTP crates are each exactly 100%; `hitool-http` contributes 2,732 regions, 245 functions, and 1,650 lines, while CI requires 100% workspace-wide |
