...
| 100% test coverage | in progress | current all-feature baseline: lines 98.39% (23,377/23,759), regions 98.36% (38,306/38,943), functions 97.81% (3,171/3,242); the facade registry, JWT, cache, system, cron, setting, AI, log, JSON, and HTTP crates are each exactly 100%; `hitool-http` contributes 1,849 regions, 173 functions, and 1,165 lines, while CI requires 100% workspace-wide |
