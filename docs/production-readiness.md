...
| 100% test coverage | in progress | current all-feature baseline: lines 93.72%, regions 93.97%, functions 92.84%; new collection, getter, clone, compiler, stream, compression, AOP, DFA, bloom-filter, script, and CAPTCHA implementations are 100% across regions, functions, lines, and generic instantiations, while CI requires 100% workspace-wide |
