...
| Complete Hutool functional parity | in progress | pinned v5.8.46 inventory contains 13,871 public production API records; 616 records have implementation and executable evidence: all 175 `core.codec`, 422 `core.collection`, 9 `core.getter`, and 10 `core.clone` records |
...
| 100% test coverage | in progress | current all-feature baseline: lines 88.97%, regions 89.36%, functions 87.97%; new collection, getter, and clone implementations are 100% across all three metrics and CI requires 100% workspace-wide |
