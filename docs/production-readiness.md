...
| Complete Hutool functional parity | in progress | pinned v5.8.46 inventory contains 13,871 public production API records; 280 records have implementation and executable evidence: all 175 `core.codec` records plus 105 reviewed `core.collection` records |
...
| 100% test coverage | in progress | current all-feature baseline: lines 84.90%, regions 85.63%, functions 83.01%; new collection type, partition, and iterator code is 100% across all three metrics and CI requires 100% workspace-wide |
