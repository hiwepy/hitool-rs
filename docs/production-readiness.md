...
| Complete Hutool functional parity | in progress | pinned v5.8.46 inventory contains 13,871 public production API records; every record requires implementation and test evidence |
...
| 100% test coverage | in progress | current all-feature baseline: lines 77.99%, regions 78.41%, functions 76.70%; CI requires 100% for all three |
