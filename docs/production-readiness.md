...
| 100% test coverage | in progress | current all-feature baseline: lines 95.23% (14,496/15,222), regions 95.45% (23,890/25,028), functions 94.79% (2,003/2,113); the facade registry is exactly 100% (119 regions, 8 functions, 60 lines), JWT is exactly 100% (2,029 regions, 143 functions, 1,148 lines), and cache is exactly 100% (1,881 regions, 180 functions, 1,140 lines), while CI requires 100% workspace-wide |
