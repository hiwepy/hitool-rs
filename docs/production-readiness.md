...
| Complete Hutool functional parity | in progress | pinned v5.8.46 inventory contains 13,871 public production API records; 233 records have implementation and executable evidence: all 175 `core.codec` records plus 58 reviewed `core.collection` records |
...
| 100% test coverage | in progress | current all-feature baseline: lines 84.20%, regions 84.99%, functions 81.97%; new collection type and partition code is 100% across all three metrics and CI requires 100% workspace-wide |
