...
| Complete Hutool functional parity | in progress | pinned v5.8.46 inventory contains 13,871 public production API records; 73 reviewed codec records currently have implementation and test evidence |
...
| 100% test coverage | in progress | current all-feature baseline: lines 81.68%, regions 82.30%, functions 79.29%; CI requires 100% for all three |
