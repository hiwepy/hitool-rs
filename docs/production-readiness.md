...
| Complete Hutool functional parity | in progress | pinned v5.8.46 inventory contains 13,871 public production API records; 216 records have implementation and executable evidence: all 175 `core.codec` records plus 41 reviewed `core.collection` records |
...
| 100% test coverage | in progress | current all-feature baseline: lines 83.81%, regions 84.57%, functions 81.51%; new `collection_types` code is 100% across all three metrics and CI requires 100% workspace-wide |
