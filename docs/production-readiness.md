...
| 100% test coverage | in progress | current all-feature baseline: lines 97.34% (20,419/20,978), regions 97.26% (33,124/34,057), functions 96.83% (2,748/2,838); the facade registry is exactly 100% (119 regions, 8 functions, 60 lines), JWT is exactly 100% (2,029 regions, 143 functions, 1,148 lines), cache is exactly 100% (1,881 regions, 180 functions, 1,140 lines), system is exactly 100% (1,018 regions, 109 functions, 694 lines), cron is exactly 100% (3,818 regions, 338 functions, 2,547 lines), setting is exactly 100% (2,860 regions, 217 functions, 1,618 lines), and AI is exactly 100% (1,928 regions, 116 functions, 1,351 lines), while CI requires 100% workspace-wide |
