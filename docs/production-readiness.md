...
| 100% test coverage | in progress | current all-feature baseline: lines 92.66%, regions 92.97%, functions 92.00%; new collection, getter, clone, compiler, stream, compression, AOP, DFA, bloom-filter, and script implementations are 100% across regions, functions, lines, and generic instantiations, while CI requires 100% workspace-wide |
