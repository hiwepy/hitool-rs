...
| 100% test coverage | in progress | current all-feature baseline: lines 98.53% (25,684/26,066), regions 98.50% (41,933/42,570), functions 98.05% (3,561/3,632); the facade registry, JWT, cache, system, cron, setting, AI, log, JSON, and HTTP crates are each exactly 100%, `hitool-core/src/builder.rs` is exactly 100% across 723 lines, 1,073 regions, and 118 functions, and `hitool-core/src/mutable.rs` is exactly 100% across 351 lines, 500 regions, and 96 functions; CI still requires 100% workspace-wide |
