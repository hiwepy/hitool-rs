...
| `hutool-core` | `hitool-core` | idiomatic | strings, collections, codecs, dates, IDs, closure/Serde-backed builders, and ownership-aware mutable primitive, object, and pair wrappers |
