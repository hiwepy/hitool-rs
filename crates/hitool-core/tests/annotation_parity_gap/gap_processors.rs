...
use hitool_core::annotation::fixtures_aggregate::{self, types as agg};
...
impl AnnotationSynthesizer for NoOpSynthesizer {
    fn get_source(&self) -> Vec<Arc<hitool_core::annotation::AnnotationMirror>> {
        vec![]
    }
    fn get_annotation_selector(
        &self,
    ) -> Arc<dyn hitool_core::annotation::SynthesizedAnnotationSelector> {
        nearest_selector()
    }
    fn get_annotation_attribute_processor(
        &self,
    ) -> Arc<dyn hitool_core::annotation::SynthesizedAnnotationAttributeProcessor> {
    ...
    fn synthesize(
        &self,
        _annotation_type: AnnotationTypeName,
    ) -> Option<Arc<hitool_core::annotation::AnnotationMirror>> {
        None
    }
    fn get_attribute_value(
        &self,
        _attribute_name: &str,
        _attribute_type: hitool_core::annotation::ValueKind,
    ) -> Option<hitool_core::annotation::AnnotationValue> {
        None
    }
}
