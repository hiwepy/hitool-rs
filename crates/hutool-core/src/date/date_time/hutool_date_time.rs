...
pub(crate) fn between_unit(begin: DateTime, end: DateTime, unit: DateUnit) -> i64 {
...
pub(crate) fn week_of_year_mon_min1(date: NaiveDate) -> u32 {
...
pub(crate) fn parity_zone() -> FixedOffset {
    FixedOffset::east_opt(8 * 3600).expect("fixed +08:00")
}

pub(crate) fn format_with_pattern(dt: DateTime, pattern: &str) -> String {
    if pattern == "#sss" {
