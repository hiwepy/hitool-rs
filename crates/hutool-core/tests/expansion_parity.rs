...
#[test]
fn f03() { let p = "/tmp/test_expansion.txt"; FileUtil::write_utf8_string(p, "test").unwrap(); assert_eq!(FileUtil::read_utf8_string(p).unwrap(), "test"); FileUtil::delete(p).unwrap(); }
