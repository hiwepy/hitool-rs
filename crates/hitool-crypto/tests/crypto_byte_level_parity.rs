//! 1:1 byte-level parity tests comparing hitool-crypto output to hutool-crypto.
//!
...
fn load_vectors() -> Vec<Vector> {
    ...
    path.pop(); // crates/hitool-crypto -> crates
...
fn aes_cbc_256_roundtrip() {
    // hitool-crypto provides aes128_cbc_* as a stable interface. For aes256
...
// rc4_roundtrip removed: rc4_encrypt/rc4_decrypt not exported from hitool_crypto
