//! Hutool `hutool-script` → hitool-script test parity.
//!
//! 对齐: `cn.hutool.script.test.ScriptUtilTest`
//!
//! Language note: Hutool defaults to JSR-223 JavaScript; hitool-script uses sandboxed
...
use hitool_script::{ScriptContext, ScriptEngine, ScriptLimits, ScriptUtil};
...
/// hitool-script does not link an optional Python engine — identical successful eval is
